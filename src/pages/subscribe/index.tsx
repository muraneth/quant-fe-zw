...
const Subscribe = () => {
  ...
  const { run: getPayMethd, loading: methodsLoading } = useRequest(
    () => getPaymentMethods(),
    {
      ready: true,
      manual: true,
  ...
  const renderSubscribeButton = (plan: Plan) => {
    ...
    if (plan.is_popular) {
      return (
        <div
          className={`${styles.btn} ${styles.popolarPlan}`}
      ...
      <div className={styles.payment}>
        <div className={styles.right}>
          ...
          <div style={{ color: "gray", paddingBottom: 16 }}>
            ...
            takes longer. If you meet any issue, get in touch with me{" "}
            <a href="https://t.me/mura202211">Telegram</a>
          </div>
        </div>
      </div>
    ),
